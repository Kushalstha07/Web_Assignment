...
export default function AppointmentsPage() {
  ...
  return <div className="space-y-6">
    <div className="flex flex-wrap items-center justify-between gap-3"><div><h1 className="text-3xl font-bold text-[#0F172A]">Appointments</h1><p className="mt-1 text-sm text-[#64748B]">Your real booking schedule.</p></div><Button onClick={() => router.push("/counsellors")}><CalendarIcon className="h-4 w-4"/>Book appointment</Button></div>

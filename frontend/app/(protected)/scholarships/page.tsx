...
export default function ScholarshipsPage() {
  ...
  return <div className="space-y-6">
    <div><h1 className="text-3xl font-bold text-[#0F172A]">Scholarships</h1><p className="mt-1 text-sm text-[#64748B]">Search current opportunities from the scholarship API.</p></div>
